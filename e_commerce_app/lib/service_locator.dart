...
import 'package:e_commerce_app/data/order/source/order_firebase_service.dart';
...
import 'package:e_commerce_app/domain/auth/usecases/signin.dart';
import 'package:e_commerce_app/domain/auth/usecases/siginup.dart';
...
import 'package:e_commerce_app/domain/order/usecases/add_to_cart.dart';
import 'package:e_commerce_app/domain/order/usecases/get_cart_products.dart';
import 'package:e_commerce_app/domain/order/usecases/get_orders.dart';
import 'package:e_commerce_app/domain/order/usecases/order_registration.dart';
import 'package:e_commerce_app/domain/order/usecases/remove_cart_product.dart';
import 'package:e_commerce_app/domain/product/repository/product.dart';
import 'package:e_commerce_app/domain/product/usecases/add_or_remove_favorite_product.dart';
import 'package:e_commerce_app/domain/product/usecases/get_favorties_products.dart';
...
import 'package:e_commerce_app/domain/product/usecases/get_products_by_title.dart';
import 'package:e_commerce_app/domain/product/usecases/get_top_selling.dart';
import 'package:e_commerce_app/domain/product/usecases/is_favorite.dart';
